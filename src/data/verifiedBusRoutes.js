...
import { INDIA_METRO_SYSTEMS } from './indiaTransitDataset.js';
...
export const ALL_MTC_ROUTES = [...VERIFIED_MTC_BUS_ROUTES, ...(MTC_CSV_BUS_ROUTES || []), ...(METRO_CSV_ROUTES || []), ...(INDIA_METRO_SYSTEMS || [])];
